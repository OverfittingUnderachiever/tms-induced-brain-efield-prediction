# tms_efield_prediction/models/architectures/simple_unet_magnitude.py
"""
Simple UNet architecture for TMS E-field magnitude prediction.

This model predicts only the magnitude of the E-field, not the direction.
It uses a standard 3D UNet architecture with configurable parameters.
"""
...
class SimpleUNetMagnitudeModel(BaseModel):
    """Simple UNet model for predicting E-field magnitude.
    
    This model takes MRI and dA/dt data as input and predicts the 
    magnitude of the resulting E-field using a 3D UNet architecture.
    """
    
    def __init__(self, config: Dict[str, Any], context: Optional[Any] = None):
        """Initialize the UNet magnitude model.
        ...
        # New parameter: feature multiplier (defaults to 2.0 for backward compatibility)
        ...
        # Log configuration
        logger.info(f"UNet Config: Input Channels={self.input_channels}, Output Channels={self.output_channels}, "
        ...
        # Build the model
        logger.info("Building UNet architecture...")
        self._build_model()
        logger.info("UNet architecture building complete.")
    ...
    def validate_config(self) -> bool:
        ...
        # Additional validation for SimpleUNetMagnitudeModel
    ...
    def _build_model(self):
        ...
        self.initial_conv = Conv3DBlock(
            ...
            # Remove the dropout_rate parameter here
        )
